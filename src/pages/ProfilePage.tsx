...
import { RiMailFill, RiPhoneFill, RiEdit2Fill, RiLockPasswordFill } from "@remixicon/react";
    ...
    <div className="w-full max-w-md mx-auto overflow-hidden pt-10">
      ...
      <div className="p-6 bg-white dark:bg-slate-900 shadow-xl text-center relative rounded-3xl">
        ...
        <div className="flex flex-col items-center">
          ...
          <h1 className="text-xl font-bold mt-3">{profile?.first_name} {profile?.last_name}</h1>
