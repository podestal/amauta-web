...
const ClassroomSummary = ({ classrooms }: Props) => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h2 className="text-3xl font-bold text-center mb-6 dark:text-white">Alumnos de matrículados: {totalStudents}</h2>
        ...
        <div className="w-full grid gap-6 xl:grid-cols-4">
          {secondary.map((classroom) => (
            <motion.div
              ...
              className="relative bg-gray-800 hover:bg-gray-600 shadow-lg rounded-xl p-6 flex flex-col items-center justify-center border border-gray-200 dark:border-gray-700"
            >
